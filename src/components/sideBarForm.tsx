...
import { ScheduleFormHeaderProps, FormData } from "@/types";
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid w-full items-center gap-1.5">
                        ...
                        <Select
                            ...
                            classNamePrefix="react-select"
                            name="semester"
                            value={typeof formData.semester === 'number' ? { value: formData.semester, label: `${formData.semester} - ${["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"][formData.semester - 1]}` } : null}
                    ...
                    <Button
                        ...
                        variant="default"
                        className={`w-full ${allIDs.includes(formData.ID) &&
