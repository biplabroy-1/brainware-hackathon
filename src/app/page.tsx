...
export default function Home() {
  ...
  return (
    ...
    >
          ...
          {isSignedIn ? (
            ...
            <div className="flex gap-2">
              <SignInButton mode="modal">
                <Button
                  variant="outline"
                  className="border-gray-700 text-black hover:bg-gray-800 hover:text-slate-50"
                >
                  Sign In
                </Button>
              </SignInButton>
      ...
      <Spotlight className="max-w-6xl mx-auto pt-20 md:pt-24 pb-2 absolute" />
      <div className="container px-4 mx-auto text-center pt-32">
        <motion.div variants={childVariants} className="relative mb-6">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            <div className="flex items-center justify-center flex-wrap">
              <span className=" mr-5 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-blue-500">
                Your personal{" "}
              </span>
          ...
          {!isSignedIn && (
            <>
              ...
              <Link href="#features">
                <Button
                  variant="outline"
                  className="border-gray-700 text-black hover:bg-gray-800 hover:text-gray-50 px-8 py-6"
                >
                  Learn More
                </Button>
              </Link>
      ...
      <section id="features" className="py-20 bg-gray-900 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-500/10 to-transparent pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="mb-8 text-gray-700">
                  The app features an intuitive interface that helps
                  administrators create and manage class schedules with ease.
                  It&apos;s designed to be flexible enough to handle various
                  course structures, instructor assignments, and room
                  allocations.
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-20 bg-black relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-indigo-500/10 to-transparent pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-black relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/5 to-transparent pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
